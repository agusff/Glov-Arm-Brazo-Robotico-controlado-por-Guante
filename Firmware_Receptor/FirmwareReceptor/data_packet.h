...
#define UART_CMD_VINCULAR     0x01   // STM32 -> receptor: "vinculate y despertá al guante"
#define UART_CMD_DESVINCULAR  0x00   // STM32 -> receptor: "dormí al guante y desvinculate"
